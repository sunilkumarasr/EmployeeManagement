...
class ViewAttendanceNewActivity : AppCompatActivity() {
    ...
    fun getattendance(year:String, month:String)
    {
       ...
       // val cal: Calendar = Calendar.getInstance()
        ...
        val customDialog= CustomDialog(this@ViewAttendanceNewActivity);
        customDialog.showDialog(this@ViewAttendanceNewActivity,true)
